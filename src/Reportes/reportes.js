...
function Reportes() {
    ...
    const cargarVentas = async () => {
        ...
        try {
            ...
            const res = await axios.get(`${process.env.REACT_APP_API_VENTAS}/ventas/listar`);
            setDatos(res.data || []);
        } catch (e) { 
    ...
    const verDetalleIndividual = async (idVenta) => {
        try {
            const res = await axios.get(`${process.env.REACT_APP_API_VENTAS}/api/detalleventas/listar`);
    ...
    const generarReporteSeleccionado = async () => {
        ...
        if (tipoReporte === "clientes") {
            ...
            try {
                ...
                const resDetalles = await axios.get(`${process.env.REACT_APP_API_VENTAS}/api/detalleventas/listar`);
